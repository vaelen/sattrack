...
```sh
sudo apt install build-essential cmake libgtkmm-3.0-dev libcurl4-openssl-dev libcurlpp-dev rapidjson-dev libcli11-dev libtomlplusplus-dev
```
...
SatTrack is a GTK++ application and is built using C++17. I wrote it largely as an opportunity to better familiarize myself with the features of C++11, C++14, and C++17 since I originally learned C++ back in the late 90s.
...
6. [TOML++](https://github.com/marzer/tomlplusplus) for configuration file parsing.
