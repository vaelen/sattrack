...
```sh
sudo apt install build-essential cmake libgtkmm-3.0-dev libcurl4-openssl-dev libcurlpp-dev rapidjson-dev
```
...
SatTrack is a GTK++ application and is built using C++14. I wrote it largely as an opportunity to better familiarize myself with the features of C++11 and C++14 since I originally learned C++ back in the late 90s.
